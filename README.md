Project to go back on one of my very first projects, several years ago using AmOS: [Live Demo](https://GiacomoSorbi.github.io/happy-birthday).

## Technologies I wanted to use:

- `<canvas>` has been a while since I last used them for animations;
